import { StyleSheet, Share, Alert, Modal, PanResponder, TouchableOpacity, Text, View, Button } from "react-native";
...
const RenderCampsite = (props) => {
   ...
   const sharingCampsite = (ttl, msg, url) => {
      Share.share({
